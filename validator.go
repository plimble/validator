...
type Validator interface {
    ...
    ArrayStringLen(val []string, nLen int, name string, err ...errors.Error)
    ArrayIntLen(val []int, nLen int, name string, err ...errors.Error)
    ArrayInt64Len(val []int64, nLen int, name string, err ...errors.Error)
    PointerRequireString(val *string, name string, err ...errors.Error)
    PointerRequirePointerEmail(val *string, name string, err ...errors.Error)
...
func (v *validator) PointerRequireString(val *string, name string, err ...errors.Error) {
    if val != nil {
        v.RequiredString(*val, name)
    }
}

func (v *validator) PointerRequirePointerEmail(val *string, name string, err ...errors.Error) {
    if val != nil {
        v.RequiredString(*val, name)
    }
}
...
func (v *validator) ArrayStringLen(val []string, nLen int, name string, err ...errors.Error) {
    if len(val) == nLen {
        return
    }
...
func (v *validator) ArrayIntLen(val []int, nLen int, name string, err ...errors.Error) {
    if len(val) == nLen {
        return
    }
...
func (v *validator) ArrayInt64Len(val []int64, nLen int, name string, err ...errors.Error) {
    if len(val) == nLen {
        return
    }
